    ...
    namespace parallel {
        namespace mpi {
            namespace containers {
                ...
                template <typename T>
                VectorMPI<T>::VectorMPI(const communication::Communicator& comm) : _comm(comm) {}
                ...
                VectorMPI<T>::VectorMPI(
                    ...
                    _local_vector = Vector<T>(_dist_info.local_size);

                    distribution::scatter(global_vector, _dist_info, _local_vector, root, _comm);
                }
